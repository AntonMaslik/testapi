import { Body, Controller, Get, Param, Post, Put, UseGuards, Request, Req, Delete} from '@nestjs/common';
...
export class WorkSpaceController {
    ...
    @UseGuards(AccessTokenGuard)
    @Put(':id')
    updateWorkspace(@Param() id: number, @Body() updateWorkspaceDto: UpdateWorkspaceDto){
        return this.workspacesService.updateWorkspaceById(id, updateWorkspaceDto)
    }
